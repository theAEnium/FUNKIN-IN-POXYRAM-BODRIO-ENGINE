...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		gief.antialiasing = ClientPrefs.globalAntialiasing;
		...
		bief.antialiasing = ClientPrefs.globalAntialiasing;
		...
		waos.antialiasing = ClientPrefs.globalAntialiasing;
		waos.screenCenter();
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Bodrio Engine (P.E.)v" + psychEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("PhantomMuff 1.5", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Friday Night Funkin' Proxyram v" + Application.current.meta.get('version'), 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("PhantomMuff 1.5", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
